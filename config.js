...
module.exports = {
    ...
    BOT_INFO: process.env.BOT_INFO || 'Izumie;SHXME3M;918593848438;https://i.imgur.com/uBsfozE.jpeg;https://chat.whatsapp.com/LcY3uzJyimr7nopSVALIOK',
    RBG_KEY: process.env.RBG_KEY || '4TXVj3JrM1rTD6N67ZnuM5HK',
    ALLOWED: process.env.ALLOWED || '91',
    NOT_ALLOWED: process.env.ALLOWED || '94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "918593848438",
    BOT_NAME: process.env.BOT_NAME || 'IzUmI',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝚰𝚭𝐔𝚳𝚰¹¹ꫂ;Izumie MD bot;https://i.imgur.com/uBsfozE.jpeg' : process.env.AUDIO_DATA,
    ...
    SUDO: process.env.SUDO || "918593848438",
